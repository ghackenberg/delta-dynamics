    ...
    >
      ...
      >
        <div className="flex flex-col items-center text-center mb-10">
          ...
          <h2 className="text-2xl font-black uppercase tracking-[0.3em] text-white">Rename Terrain</h2>
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white placeholder:text-white/10 focus:outline-none focus:border-blue-500/50 transition-all font-bold"
            />
          </div>
